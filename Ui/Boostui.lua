...
-- task.spawn(function()
    ...
    local function CreateSlider(name, min, max, default, callback)
        ...
        frame.BackgroundTransparency = 1
        frame.       local label = Instance.new("TextLabel")
       ...
       e.new("UICorner")
        ...
        RegisterTheme(sliderFill, "BackgrillCorner = Instance.new("UICorner")
        fillCorner.CornerRadius = UDim.new(1, 0)
        ...
        valLabel.Size = UDim2.nLabel.Position = UDim2.new(1, -60, 0, -25)
        ...
        local function Update(input)
            local pos    local rPos = pos - sliderBg.AbsolutePosition.X
